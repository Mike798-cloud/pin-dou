window.XM_DATA = (() => {
  ...
  return {
    ...
    plaza: [
      ...
      {id:'p06', date:'2025/07/12 16:20', author:'薄荷', title:'周末人好多', tags:['闲聊'], visual:'assets/img/rain-window-shelf.jpg', text:'四张桌子全满，隔壁姐妹拼一只超级大的柴犬，围观了半小时。', comments:['椒盐：我也看到了！','阿闻：那桌最后真的拼到闭店。','薄荷：她们还在争耳朵到底要不要多一圈深灰。','青提：那天我在隔壁桌，听她们讨论耳朵讨论了二十分钟。','薄荷：最后深灰还是少了一圈哈哈。','阿闻：柴犬那张后来寄存了，真的很大。']},
      {id:'p47', date:'2025/07/17 18:24', author:'橘子汽水', title:'第一次来就碰上下雨', tags:['返图','雨天'], visual:'assets/img/rain-window-shelf.jpg', text:'本来只是想躲一会雨，结果坐到店里快打烊。窗边那排盒子在阴天里看着特别温柔。', comments:['春卷：雨天去真的会上瘾。','阿闻：窗边会有一点反光，拍照记得关闪。','橘子汽水：已经记下了，下次想试 03 号桌。']},
      {id:'p53', date:'2025/05/11 16:42', author:'橘子汽水', title:'给妈妈做的小花比想象中难', tags:['返图','求助'], visual:'assets/img/pegboard-close.jpg', text:'以为十几格的小花半小时能结束，结果为了叶子的绿色拆了三次。最后选了鼠尾草。', comments:['木木：鼠尾草和奶黄一起很好看。','阿闻：小图的难点经常全在配色。','橘子汽水：已经送出去了，她说像小盆栽。']},
      ...
      {id:'p37', date:'2025/07/15 20:13', author:'木木', title:'闭店前一阵灰蓝真的快被拿空了', tags:['闲聊','材料'], visual:'assets/img/shelf-bins-soft.jpg', text:'这几周来的人好多都在拿灰蓝。感觉这个店里每隔一段时间就会突然流行某个颜色。', comments:['阿闻：上一次是奶黄。','薄荷：我就是被你们带的。','木木：灰蓝真的太适合阴天了。']},
      ...
      {id:'p04', date:'2025/07/19 19:36', author:'唐梨', title:'还是蓝色好看', tags:['返图','灰蓝'], visual:'assets/img/umbrella-table.jpg', text:'纠结了半小时，最后还是把边框换回灰蓝。M31 快没了，店员说新版色号已经到了。', comments:['阿闻：你已经连续三次选蓝色了😂','唐梨：因为某人以前说蓝色耐看。','海盐：这次边框比上次浅一点。','唐梨：嗯，旧色快用完了。']},
      ...
      {id:'p01', date:'2025/07/26 21:08', author:'阿闻', title:'今天最后一位客人拼到打烊', tags:['店员日常','晚场'], visual:'assets/img/tablet-mug.jpg', text:'灰蓝豆又快见底了。最后一位客人说剩下那一点下次再来补。桌上两杯饮料最后都化得差不多。', comments:['@九格：你们几点打烊？','阿闻：平时十点，今天拖到十点半。','青提：两杯都化了说明聊很久。','阿闻：后面其实没怎么说话，就是一直坐着。']},
      {id:'p52', date:'2025/06/26 21:37', author:'唐梨', title:'展会撤完以后只想拼不用写字的东西', tags:['日常','闲聊'], visual:'assets/img/table-corner.jpg', text:'今天把最后一批物料撤完，脑子已经不想看任何标题。来店里做了一个没有字的小挂件，舒服很多。', comments:['小严：你明天还要整理照片。','唐梨：明天的我会处理。','阿闻：今天她连色号都让我念。','唐梨：谢谢人工语音助手。']},
      ...
      {id:'p08', date:'2025/06/16 13:55', author:'唐梨', title:'独自拼豆效率竟然更高', tags:['返图','日常'], visual:'assets/img/window-note.jpg', text:'原本约的人又加班。一个人坐了三小时，居然比以前两个人一起快。', comments:['阿闻：但你还是拿了两杯饮料。','唐梨：顺手。','青提：一个人也会拿两杯吗？','唐梨：桌子空着怪奇怪的。']},
      {id:'p27', date:'2025/07/08 21:46', author:'阿闻', title:'03号桌今天又拼公交站', tags:['店员日常','大底板'], visual:'assets/img/archive-close.jpg', text:'旧图断色三次，最后还是拿历史预览一点点补。那个人说“反正站牌歪一点也看得出来”。', comments:['青提：03号桌是不是窗边那个？','阿闻：对，雨天最容易被窗户反光照到。','海盐：谁会把站牌做这么细。','阿闻：会把细边拆了又装的人。']},
      {id:'p10', date:'2025/05/03 15:01', author:'小满豆作', title:'五一预约已满', tags:['预约'], text:'5 月 3 日至 5 日所有时段已满，现场候位时间约 40–80 分钟。', comments:[]},
      {id:'p03', date:'2025/07/21 17:44', author:'棉花糖', title:'小猫杯垫翻车但意外能用', tags:['返图','杯垫'], visual:'assets/img/mug-close.jpg', text:'耳朵熨歪了，不过正好拿来压便签。老板说失败品不要急着扔。', comments:['西瓜泡泡：有点像故意做旧。','阿闻：失败品区欢迎你。','棉花糖：我已经开始觉得它可爱了。']},
      {id:'p11', date:'2025/04/11 22:09', author:'阿闻', title:'今天有人把坏掉的作品留给我当杯垫', tags:['店员日常'], visual:'assets/img/mug-close.jpg', text:'边缘彻底熨糊，但当杯垫居然很稳。她说下次再做一个正常的。', comments:['唐梨：不许丢。','阿闻：好，不丢。','木木：失败品也有失败品的归宿。']},
      {id:'p42', date:'2025/03/28 20:55', author:'海盐', title:'把上次没拼完的雨伞补完了', tags:['返图','雨伞'], visual:'assets/img/umbrella-table.jpg', text:'上回差一点没收尾，这次终于补完。小图虽然简单，但补最后几颗的时候莫名会舍不得结束。', comments:['春卷：雨伞真的很适合做挂件。','阿闻：你这次终于没把白色和奶白搞混。','海盐：店员记仇了。']},
      ...
      {id:'p46', date:'2025/05/28 22:04', author:'唐梨', title:'下班后绕路来店里坐一会', tags:['日常','闲聊'], visual:'assets/img/window-note.jpg', text:'没有想做很完整的东西，就是想把脑子里还在转的那点东西安静一下。店里灯有点黄，坐着就会慢下来。', comments:['青提：这种店最适合下班后发呆。','阿闻：你今天只拼了一个角。','唐梨：一个角也算开始。']},
      {id:'p29', date:'2025/06/02 20:41', author:'唐梨', title:'今天只想做不用改第七版的东西', tags:['日常','返图'], visual:'assets/img/table-corner.jpg', text:'白天的展板又改了一轮，下班后坐窗边拼了一个小时。小东西有个好处：哪里不对，自己拿起来改就行。', comments:['小严：你明天还是要改第八版。','唐梨：别提醒我。','阿闻：今天看起来确实像来避难的。']},
      {id:'p19', date:'2025/07/30 10:26', author:'阿闻', title:'柜台抽屉先别清', tags:['店员日常'], visual:'assets/img/mug-close.jpg', text:'柜台里那只熨坏的杯垫先不清了。昨天从共同朋友那里才知道，唐梨以后不会再来拿了。', comments:['纸飞机：她是 27 号走的，之前一直没敢跟你说。','阿闻：知道了。先放着吧。','木木：看到这条突然有点难受。','阿闻：嗯，先给她留着。','橘子：抽屉里那只我好像见过。','阿闻：嗯，边缘熨得有点糊，很好认。']},
      {id:'p12', date:'2025/03/07 11:40', author:'春卷', title:'第一次做像素雨伞', tags:['返图','雨伞'], visual:'assets/img/umbrella-table.jpg', text:'蓝色比想象中更显灰，放在包上很好看。', comments:['木木：这个配色很温柔。','阿闻：小图做完特别有成就感。']},
      {id:'p56', date:'2025/01/18 19:54', author:'阿闻', title:'复习座位今天被客人占了', tags:['店员日常','闲聊'], visual:'assets/img/window-note.jpg', text:'我平时在前台最里面那张小桌背题，今天满场，只能抱着书坐收银台后面。五分钟后又开始帮人找 M16。', comments:['木木：备考店员在线答疑。','唐梨：你最后还是没背几页吧。','阿闻：闭嘴。','青提：祝考试顺利！']},
      {id:'p35', date:'2025/01/08 22:36', author:'阿闻', title:'考完一门来值晚班', tags:['店员日常','闲聊'], visual:'assets/img/window-note.jpg', text:'脑子里全是选择题，今晚谁来都不要问我“这个蓝和那个蓝哪个好看”。我会让你两个都买。', comments:['木木：店员开始报复社会。','青提：你明明最后还是很认真帮我挑了。','阿闻：职业习惯，没办法。']},
      ...
      {id:'p14', date:'2024/11/02 16:33', author:'可乐加冰', title:'两个人拼同一张图真的会吵架', tags:['搭子项目'], visual:'assets/img/table-corner.jpg', text:'一个嫌颜色不对，一个嫌强迫症。最后还是一起拼完了。', comments:['唐梨：太真实了。','海盐：还有一种情况是两个人都嫌对方手速慢。','林未：以及有人会因为一颗歪了重来。','可乐加冰：对，就是这种。','阿闻：所以我才总说共同项目记得先分区。','九格：我们是一个嫌快一个嫌慢。','薄荷：双人项目最好开工前先分区。']},
      {id:'p43', date:'2024/10/25 18:16', author:'青提', title:'店员说我选色像在点奶茶', tags:['闲聊','配色'], visual:'assets/img/shelf-bins-soft.jpg', text:'先要一点奶黄，再来一点灰蓝，最后又嫌粉紫太甜。配色这件事真的会犹豫很久。', comments:['阿闻：因为你站在色墙前二十分钟没挪。','青提：艺术需要时间。','木木：我也会这样。']},
      ...
      {id:'p31', date:'2024/09/03 21:28', author:'唐梨', title:'如果周末真的去摆摊', tags:['闲聊','日常'], visual:'assets/img/shelf-clock.jpg', text:'想过做一些很小的挂件，不接复杂定制，只摆自己喜欢的颜色。想法目前停留在“买了一个收纳箱”。', comments:['青提：这已经是第一步了。','唐梨：第一步放了两个月。','小严：第二步是先把收纳箱拆开。','海盐：只卖自己喜欢的颜色这个想法很好。','唐梨：这样至少不用解释为什么不接定制。']},
      {id:'p38', date:'2024/08/28 20:12', author:'九九', title:'第一次做 32×32 结果只拼了边框', tags:['返图','大底板'], visual:'assets/img/pegboard-close.jpg', text:'想挑战一个复杂点的图，结果时间全花在边框和选色上。下次真的要先画草稿。', comments:['阿闻：大底板很容易高估自己。','九九：我今天充分感受到了。','海盐：能拼完边框已经很强了。']},
      {id:'p15', date:'2024/08/17 19:05', author:'阿闻', title:'今天的公交站牌好难熨', tags:['店员日常','大底板'], visual:'assets/img/archive-close.jpg', text:'边缘太细，来回补了三次。下次做同款我一定先拍照留底。', comments:['木木：细边真的很难。','阿闻：尤其那种明明看着差不多、拼起来却差一格的。']},
      ...
      {id:'p28', date:'2024/07/19 19:02', author:'阿闻', title:'雨天关店前的桌面', tags:['店员日常','雨天'], visual:'assets/img/rain-window-shelf.jpg', text:'今天雨大，窗边桌全是水印。有人走的时候忘了一把蓝色折叠伞，已经挂前台了。', comments:['海盐：雨天的店里真的很好看。','阿闻：就是拖地很累。']},
      {id:'p16', date:'2024/07/19 17:19', author:'林未', title:'下雨也要来拼', tags:['返图','雨天'], visual:'assets/img/umbrella-table.jpg', text:'躲雨躲进店里，最后干脆坐了一下午。', comments:['唐梨：你还把伞忘在店里。','林未：你不是拿了吗。','阿闻：前台那把蓝色折叠伞你们到底谁的。','唐梨：先算她的。']},
      {id:'p39', date:'2024/07/06 16:18', author:'海盐', title:'03号桌的窗边位置很适合发呆', tags:['闲聊','门店'], visual:'assets/img/rain-window-shelf.jpg', text:'如果不赶时间的话，真的很推荐坐靠窗的位置。下雨的时候会想一直待着。', comments:['青提：就是拍照会反光。','阿闻：以及空调口不在那边，夏天会稍微热一点。']},
      ...
      {id:'p20', date:'2024/06/08 16:11', author:'海盐', title:'第一次做手机挂件', tags:['返图','新手'], visual:'assets/img/pegboard-close.jpg', text:'小图真的很适合新手，两小时内能做完，回家一路都在看。', comments:['阿闻：记得别暴晒，会有一点点翘。','橘子汽水：这类小图送朋友也很合适。']},
      {id:'p45', date:'2024/05/28 19:10', author:'林未', title:'低饱和绿色真的很耐看', tags:['返图','配色'], visual:'assets/img/shelf-bins-soft.jpg', text:'以前总觉得绿色会很跳，今天试了鼠尾草，意外很安静。放在灰蓝旁边也不吵。', comments:['唐梨：终于不是只会拿蓝色了。','林未：是在你的监督下试的。','青提：这个配色听起来就好看。']},
      {id:'p21', date:'2024/05/20 19:48', author:'青提', title:'情侣款最后做成了姐妹款', tags:['返图','搭子项目'], visual:'assets/img/table-corner.jpg', text:'朋友临时来救场，最后把原本的情侣配色改掉了，意外更好看。', comments:['木木：有些图真的更适合姐妹色。','阿闻：现场救场经常会出现更好的版本。']},
      {id:'p32', date:'2024/04/14 15:32', author:'唐梨', title:'同事的工位门牌终于交货', tags:['返图','日常'], visual:'assets/img/window-note.jpg', text:'小严催了三周。字比图难拼，最后一排拆了四次才顺眼。', comments:['小严：本人验收通过。','阿闻：你俩下班以后还在验收😂','林未：我可以理解拆四次这件事。']},
      {id:'p36', date:'2024/03/30 18:43', author:'阿闻', title:'我把自己的第一块熨坏了', tags:['店员日常','返图'], visual:'assets/img/mug-close.jpg', text:'每天帮别人熨，轮到自己反而压太久。现在它是前台最丑但最牢的杯垫。', comments:['唐梨：所以你不能再笑我的。','阿闻：你的还是更丑一点。','海盐：失败杯垫区越来越热闹。']},
      ...
      {id:'p48', date:'2024/01/14 19:21', author:'阿闻', title:'工作台03充电线又不见了', tags:['店员日常','门店'], visual:'assets/img/archive-close.jpg', text:'每次都说要给 03 号桌的平板贴名字，结果最后总是只剩一根松松的线。', comments:['木木：03号桌真的很抢手。','阿闻：所以配件也最容易失踪。','青提：是不是又被卷进桌底了。']},
      {id:'p23', date:'2023/12/31 18:50', author:'阿闻', title:'今年最后一桌收工', tags:['店员日常'], visual:'assets/img/window-note.jpg', text:'地上捡了四十多颗豆，最大的愿望是明年大家都把豆倒进盘子里再选。', comments:['九九：不可能。','木木：新年愿望不要太难。','阿闻：那改成“至少倒一半”。']},
      ...
      {id:'p40', date:'2023/08/22 17:08', author:'阿闻', title:'有人把寄存单夹在书里了', tags:['店员日常','寄存'], visual:'assets/img/archive-close.jpg', text:'今天整理柜台时，在一本本子里翻出半年前的寄存单。还好字迹够大，一眼认出是谁的。', comments:['阿闻：后来那张寄存单被我夹进了专门的文件夹。']},
      ...
      {id:'p61', date:'2023/07/19 18:11', author:'林未', title:'今天两个人都没带伞', tags:['闲聊','雨天'], visual:'assets/img/rain-window-shelf.jpg', text:'本来约好下班后只坐一小时，结果雨一直没停，硬是拖到店里快关门。', comments:['唐梨：是谁说天气预报肯定不准。','林未：不记得。','阿闻：前台借伞记录还留着。','唐梨：那就更不记得了。','木木：你们两个怎么每次下雨都在店里。']},
      {id:'p49', date:'2023/06/18 15:33', author:'小严', title:'把去年寄存的门牌取走了', tags:['寄存','返图'], visual:'assets/img/window-note.jpg', text:'一直放在店里忘了拿，今天终于顺路带走。发现自己去年选的颜色比现在更高饱和。', comments:['唐梨：你终于。','阿闻：寄存柜感动落泪。']},
      {id:'p41', date:'2023/05/12 20:07', author:'薄荷', title:'周五晚场比想象中安静', tags:['闲聊','晚场'], visual:'assets/img/tablet-mug.jpg', text:'本来以为会很吵，结果大家都在低头拼自己的东西，偶尔才有人抬头问一句“这个色是不是更好”。', comments:['木木：晚场氛围真的好。','阿闻：适合做那种需要慢慢磨的图。']},
      ...
      {id:'p63', date:'2022/12/24 20:28', author:'阿闻', title:'第一场圣诞夜晚场收工', tags:['店员日常','活动','晚场'], visual:'assets/img/tablet-mug.jpg', text:'今天有人拼雪人、有人拼游戏角色，还有一桌全程只在吃饼干。最后清场的时候桌底下全是白豆。', comments:['海盐：白豆真的会隐身。','阿闻：尤其掉在浅色地板上。','木木：明年还办吗？','小满豆作：如果大家还愿意来就办。']},
      {id:'p25', date:'2022/11/19 13:17', author:'小满豆作', title:'作品寄存标签改版', tags:['寄存'], text:'寄存标签新增共同创作者栏，双人项目可以提前设置代取与转交授权。', comments:[]},
      {id:'p18', date:'2022/06/01 09:20', author:'小满豆作', title:'欢迎来到小满豆作', tags:['门店'], visual:'assets/img/rain-window-shelf.jpg', text:'把喜欢的东西，一颗一颗留下来。', comments:['海盐：那时候还只有两张桌子。','阿闻：后来才慢慢把色墙补齐。','木木：原来我已经看着这个店开这么久了。','橘子：当时路过以为是咖啡店。','青提：我第一次来还是被朋友拉进来的。']}
    ],
    works: [

window.XM_DATA = (() => {
  ...
  return {
    ...
    plaza: [
      ...
      {id:'p02', date:'2025/07/24 14:12', author:'小满豆作', title:'新手第一次来，选多大底板比较合适？', tags:['新手','FAQ'], text:'第一次建议 15×15 或 20×20。图案越大不一定越好，能在两小时内收尾更有成就感。', comments:['橙子汽水：真的，第一次做 30×30 做到怀疑人生。','海盐：15×15 小挂件非常友好。','小满豆作：如果是双人一起来，20×20 会比较好分工。']},
      {id:'p06', date:'2025/07/12 16:20', author:'薄荷', title:'周末人好多', tags:['闲聊'], visual:'assets/img/rain-window-shelf.jpg', text:'四张桌子全满，隔壁姐妹拼一只超级大的柴犬，围观了半小时。', comments:['椒盐：我也看到了！','阿闻：那桌最后真的拼到闭店。','薄荷：她们还在争耳朵到底要不要多一圈深灰。']},
      ...
      {id:'p10', date:'2025/05/03 15:01', author:'小满豆作', title:'五一预约已满', tags:['预约'], text:'5 月 3 日至 5 日所有时段已满，现场候位时间约 40–80 分钟。', comments:['青提：候位能先选色吗？','小满豆作：可以先看样品和色墙。']},
      ...
      {id:'p14', date:'2024/11/02 16:33', author:'可乐加冰', title:'两个人拼同一张图真的会吵架', tags:['搭子项目'], visual:'assets/img/table-corner.jpg', text:'一个嫌颜色不对，一个嫌强迫症。最后还是一起拼完了。', comments:['唐梨：太真实了。','海盐：还有一种情况是两个人都嫌对方手速慢。','林未：以及有人会因为一颗歪了重来。','可乐加冰：对，就是这种。','阿闻：所以我才总说共同项目记得先分区。']},
      {id:'p19', date:'2025/07/30 10:26', author:'阿闻', title:'柜台抽屉先别清', tags:['店员日常'], visual:'assets/img/mug-close.jpg', text:'柜台里那只熨坏的杯垫先不清了。昨天从共同朋友那里才知道，唐梨以后不会再来拿了。', comments:['纸飞机：她是 27 号走的，之前一直没敢跟你说。','阿闻：知道了。先放着吧。','木木：看到这条突然有点难受。','阿闻：嗯，先给她留着。']},
      ...
      {id:'p31', date:'2024/09/03 21:28', author:'唐梨', title:'如果周末真的去摆摊', tags:['闲聊','日常'], visual:'assets/img/shelf-clock.jpg', text:'想过做一些很小的挂件，不接复杂定制，只摆自己喜欢的颜色。想法目前停留在“买了一个收纳箱”。', comments:['青提：这已经是第一步了。','唐梨：第一步放了两个月。','小严：第二步是先把收纳箱拆开。']},
      ...
      {id:'p22', date:'2024/03/02 14:06', author:'小满豆作', title:'周末加开午后场', tags:['预约'], text:'3 月起周六、周日增加 12:30 入场时段。大底板建议至少预留三小时。', comments:['薄荷：午后场太需要了。','小满豆作：周末想做大板的话建议还是提前约。']},
      {id:'p33', date:'2024/02/18 16:08', author:'林未', title:'今天终于承认自己会为了歪一颗全部重排', tags:['闲聊','搭子项目'], text:'本来只是边框有一颗偏了，拆着拆着半圈都没了。有人坐对面笑了十分钟。', comments:['唐梨：差一颗也看得出来是什么。','林未：看得出来和看着难受是两件事。','海盐：我支持重排派。']},
      ...
      {id:'p17', date:'2023/10/09 12:26', author:'小满豆作', title:'搭子项目上线', tags:['系统','搭子项目'], text:'同一作品可添加 1 名共同编辑人，支持两端自动同步。', comments:['青提：终于可以和朋友一起做同一张图了。','海盐：支持分区就太好了。','小满豆作：保存记录会保留双方编辑时间。']},
      ...
      {id:'p40', date:'2023/08/22 17:08', author:'阿闻', title:'有人把寄存单夹在书里了', tags:['店员日常','寄存'], visual:'assets/img/archive-close.jpg', text:'今天整理柜台时，在一本本子里翻出半年前的寄存单。还好字迹够大，一眼认出是谁的。', comments:['橘子：寄存单真的很容易乱塞。','阿闻：所以我现在都会让大家先拍照。']},
      {id:'p24', date:'2023/08/05 17:36', author:'橘子', title:'空调下面真的不要熨', tags:['闲聊'], text:'刚压好的板子吹冷风太快，差点裂开。店员帮我重新固定住了。', comments:['阿闻：请珍惜我的手忙脚乱。','海盐：这是血泪经验。']},
      ...
      {id:'p50', date:'2023/04/20 11:12', author:'木木', title:'老会员迁移邮件竟然还在', tags:['系统','闲聊'], text:'刚整理邮箱翻到很早以前的会员通知，才想起来自己第一次去店里已经是前年了。时间过得好快。', comments:['海盐：我也还留着。','木木：那封邮件的配色现在看还是很小满豆作。']},
      {id:'p25', date:'2022/11/19 13:17', author:'小满豆作', title:'作品寄存标签改版', tags:['寄存'], text:'寄存标签新增共同创作者栏，双人项目可以提前设置代取与转交授权。', comments:['青提：这个很实用。','小满豆作：双人项目来拿成品时最容易用到。']},
      {id:'p18', date:'2022/06/01 09:20', author:'小满豆作', title:'欢迎来到小满豆作', tags:['门店'], visual:'assets/img/rain-window-shelf.jpg', text:'把喜欢的东西，一颗一颗留下来。', comments:['海盐：那时候还只有两张桌子。','阿闻：后来才慢慢把色墙补齐。','木木：原来我已经看着这个店开这么久了。']}
    ],
    works: [

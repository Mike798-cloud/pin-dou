window.XM_DATA = (() => {
  ...
  return {
    ...
    plaza: [
      ...
      {id:'p03',date:'2025/07/21 17:44',author:'棉花糖',title:'小猫杯垫翻车但意外能用',tags:['返图','杯垫'],visual:'assets/img/coaster-drawer.svg',text:'耳朵熨歪了，不过正好拿来压便签。老板说失败品不要急着扔。',comments:[]},
      {id:'p04',date:'2025/07/19 19:36',author:'唐梨',title:'还是蓝色好看',tags:['返图','灰蓝'],visual:'assets/img/bead-bins.svg',text:'纠结了半小时，最后还是把边框换回灰蓝。M31 快没了，店员说新版色号已经到了。',comments:['阿闻：你已经连续三次选蓝色了😂','唐梨：因为某人以前说蓝色耐看。']},
      ...
      {id:'p06',date:'2025/07/12 16:20',author:'薄荷',title:'周末人好多',tags:['闲聊'],visual:'assets/img/store-photo.svg',text:'四张桌子全满，隔壁姐妹拼一只超级大的柴犬，围观了半小时。',comments:['椒盐：我也看到了！']},
      {id:'p07',date:'2025/06/29 18:02',author:'阿闻',title:'谁又把镊子放进绿色豆盒了',tags:['店员日常'],visual:'assets/img/bead-bins.svg',text:'今天第三次从绿色豆盒里捞出镊子。以后每桌我都要贴一张“镊子有自己的家”。',comments:['西瓜泡泡：哈哈哈哈哈']},
      ...
      {id:'p30',date:'2025/02/14 19:17',author:'唐梨',title:'试着做了一套摆摊价签',tags:['返图','日常'],visual:'assets/img/price-tags.svg',text:'本来只是想做两个色号牌，最后顺手拼了一整套。真摆摊的话大概会先被自己收纳豆子的速度劝退。',comments:['小严：先把你答应我的工位门牌做完。','唐梨：排队。']},
      ...
      {id:'p32',date:'2024/04/14 15:32',author:'唐梨',title:'同事的工位门牌终于交货',tags:['返图','日常'],visual:'assets/img/desk-sign.svg',text:'小严催了三周。字比图难拼，最后一排拆了四次才顺眼。',comments:['小严：本人验收通过。','阿闻：你俩下班以后还在验收😂']},
      {id:'p35',date:'2025/01/08 22:36',author:'阿闻',title:'考完一门来值晚班',tags:['店员日常','闲聊'],visual:'assets/img/awen-study.svg',text:'脑子里全是选择题，今晚谁来都不要问我“这个蓝和那个蓝哪个好看”。我会让你两个都买。',comments:['木木：店员开始报复社会。']},
      ...
      {id:'p19',date:'2025/07/30 10:26',author:'阿闻',title:'柜台抽屉先别清',tags:['店员日常'],visual:'assets/img/coaster-drawer.svg',text:'柜台里那只熨坏的杯垫先不清了。昨天从共同朋友那里才知道，唐梨以后不会再来拿了。',comments:['纸飞机：她是 27 号走的，之前一直没敢跟你说。','阿闻：知道了。先放着吧。']},
      {id:'p01',date:'2025/07/26 21:08',author:'阿闻',title:'今天最后一位客人拼到打烊',tags:['店员日常','晚场'],visual:'assets/img/melted-drinks.svg',text:'灰蓝豆又快见底了。最后一位客人说剩下那一点下次再来补。桌上两杯饮料最后都化得差不多。',comments:['@九格：你们几点打烊？','阿闻：平时十点，今天拖到十点半。']},
      {id:'p27',date:'2025/07/08 21:46',author:'阿闻',title:'03号桌今天又拼公交站',tags:['店员日常','大底板'],visual:'assets/img/bus-stop.svg',text:'旧图断色三次，最后还是拿历史预览一点点补。那个人说“反正站牌歪一点也看得出来”。',comments:['青提：03号桌是不是窗边那个？','阿闻：对，雨天最容易被窗户反光照到。']},
      ...
      {id:'p28',date:'2024/07/19 19:02',author:'阿闻',title:'雨天关店前的桌面',tags:['店员日常','雨天'],visual:'assets/img/rain-day.svg',text:'今天雨大，窗边桌全是水印。有人走的时候忘了一把蓝色折叠伞，已经挂前台了。',comments:[]},
    ...
    projects: {
      umbrella: {
        id:'umbrella', title:'蓝色小雨伞', subtitle:'旧设备草稿 · 补全', size:15, pattern:patterns.umbrella,
      ...
      store: {
        id:'store', title:'便利店门口', subtitle:'共同项目 · 继续编辑', size:20, pattern:patterns.store,
      ...
      station: {
        id:'station', title:'公交站牌', subtitle:'旧图修复 · 历史预览', size:18, pattern:patterns.station,
      ...
      final: {
        id:'final', title:'IMG_0726', subtitle:'共同项目 · 旧版兼容', size:18, pattern:patterns.table,
